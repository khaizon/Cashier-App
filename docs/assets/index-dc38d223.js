...
function ti(e, t, n, r) {
  if (Fr) {
    var l = po(e, t, n, r);
    if (l === null) Ml(e, t, r, Ur, n), Zi(e, r);
    else if (lf(l, e, t, n, r)) r.stopPropagation();
    else if ((Zi(e, r), t & 4 && -1 < rf.indexOf(e))) {
      for (; l !== null; ) {
        var o = qn(l);
        if ((o !== null && Rs(o), (o = po(e, t, n, r)), o === null && Ml(e, t, r, Ur, n), o === l)) break;
        l = o;
      }
...
function Of(e, t) {
  if (Mt) return e === 'compositionend' || (!oi && As(e, t)) ? ((e = Us()), (Er = ni = nt = null), (Mt = !1), e) : null;
  switch (e) {
    case 'paste':
      return null;
    case 'keypress':
  ...
  Es(function () {
    ...
    if (!(t & 7)) {
      e: {
        ...
        if (
          ...
          if (
            ...
            (f = 'onMouseEnter'),
            (a = 'mouse'),
            (e === 'pointerout' || e === 'pointerover') && ((S = tu), (y = 'onPointerLeave'), (f = 'onPointerEnter'), (a = 'pointer')),
            (U = w == null ? h : $t(w)),
            (d = k == null ? h : $t(k)),
          ...
          w !== null && du(m, h, w, S, !1), k !== null && U !== null && du(m, U, k, S, !0);
        }
      }
      e: {
        if (
      ...
      switch (((_ = c ? $t(c) : window), e)) {
        case 'focusin':
          (lu(_) || _.contentEditable === 'true') && ((Ft = _), (ho = c), (jn = null));
          break;
        case 'focusout':
          jn = ho = Ft = null;
          break;
      ...
      else Mt ? As(e, n) && (j = 'onCompositionEnd') : e === 'keydown' && n.keyCode === 229 && (j = 'onCompositionStart');
      j &&
        ($s &&
          n.locale !== 'ko' &&
          (Mt || j !== 'onCompositionStart'
            ? j === 'onCompositionEnd' && Mt && (N = Us())
        ...
        (N = Rf ? If(e, n) : Of(e, n)) &&
          ((c = $r(c, 'onBeforeInput')),
          0 < c.length && ((v = new eu('onBeforeInput', 'beforeinput', null, n, v)), m.push({ event: v, listeners: c }), (v.data = N)));
    }
    bs(m, t);
  });
}
...
function yu(e, t, n) {
  ...
  n ? ((e = ta(e, t, Nt)), (r.__reactInternalMemoizedMergedChildContext = e), F(pe), F(oe), D(oe, e)) : F(pe), D(pe, n);
}
var Be = null,
  sl = !1,
  Ul = !1;
...
function ca(e) {
  ...
  function s(f, a, d, y) {
    ...
    return E === Dt
      ...
      : a !== null && (a.elementType === E || (typeof E == 'object' && E !== null && E.$$typeof === qe && Cu(E) === a.type))
  ...
  function k(f, a, d, y) {
    for (var E = null, _ = null, N = a, j = (a = 0), W = null; N !== null && j < d.length; j++) {
      ...
      e && N && L.alternate === null && t(f, N), (a = o(L, a, j)), _ === null ? (E = L) : (_.sibling = L), (_ = L), (N = W);
    }
  ...
  function S(f, a, d, y) {
    ...
    for (var _ = (E = null), N = a, j = (a = 0), W = null, L = d.next(); N !== null && !L.done; j++, L = d.next()) {
      N.index > j ? ((W = N), (N = null)) : (W = N.sibling);
      ...
      e && N && Pe.alternate === null && t(f, N), (a = o(Pe, a, j)), _ === null ? (E = Pe) : (_.sibling = Pe), (_ = Pe), (N = W);
    }
...
function ja(e, t, n) {
  return Pt & 21
    ? (De(n, t) || ((n = Ts()), (V.lanes |= n), (zt |= n), (e.baseState = !0)), t)
...
function id(e, t, n) {
  ...
  if (za(e)) Ta(t, l);
    ...
    (n = ia(e, t, l, r)), n !== null && ((l = ue()), Oe(n, e, r, l), La(n, t, r));
  }
}
function za(e) {
  var t = e.alternate;
        ...
        if (((e.updateQueue = null), s !== null))
          try {
            ...
            for (i = 0; i < s.length; i += 2) {
              var v = s[i],
                m = s[i + 1];
              v === 'style' ? gs(l, m) : v === 'dangerouslySetInnerHTML' ? vs(l, m) : v === 'children' ? In(l, m) : Yo(l, v, m, c);
            }
            switch (u) {
              case 'input':
                eo(l, o);
...
function ct(e) {
  return e.mode & 1
    ? R & 2 && ee !== 0
      ...
      : nd.transition !== null
      ? (Tr === 0 && (Tr = Ts()), Tr)
      : ((e = I), e !== 0 || ((e = window.event), (e = e === void 0 ? 16 : Fs(e.type))), e)
    : 1;
}
function Oe(e, t, n, r) {
    ...
    try {
      ...
      e: {
        ...
        if (((t = ee), (u.flags |= 32768), s !== null && typeof s == 'object' && typeof s.then == 'function')) {
          ...
          var w = Pu(i);
          if (w !== null) {
            (w.flags &= -257), zu(w, i, u, o, t), w.mode & 1 && ju(o, c, t), (t = w), (s = c);
            var k = t.updateQueue;
            if (k === null) {
              var S = new Set();
  ...
  p.jsx('div', {
    ...
    children: e.map(({ category: t, palette2: n, palette3: r, items: l }, o) =>
      p.jsxs(
        ...
        {
          children: [
            p.jsx('div', { className: 'categoryTitle', style: { color: r }, children: t }),
            p.jsx('div', { className: 'itemsGrid', children: l.map((i, u) => p.jsx(Md, { item: i, bg: n, fg: r }, u)) }),
          ],
        },
        o
      )
...
const $d = () => {
  const {
    ...
    v = () => {
      ...
      window.gapi.client.sheets.spreadsheets.values.append(m, w).then(
        function () {
          u(''), o('success');
        },
        function () {
                ...
                p.jsxs(
                  'tr',
                  {
                    children: [
                      ...
                      p.jsx('td', { align: 'left', children: m }),
                      p.jsx('td', { align: 'right', className: 'money', children: p.jsx('div', { children: ce.format(w) }) }),
                      p.jsx('td', { children: h }),
                      p.jsx('td', { align: 'right', className: 'money', children: p.jsx('div', { children: ce.format(k) }) }),
                    ],
                  },
                  S
                )
...
const Ad = [50, 10, 5, 2, 1, 0.5],
                ...
                children: [
                  ...
                  p.jsxs('tr', {
                    ...
                    children: [
                      ...
                      p.jsxs('td', { className: 'cashReceived money', children: ['(', ce.format(n), ')'] }),
                    ],
                  }),
                  p.jsxs('tr', {
                    children: [
    ...
    return p.jsxs('div', {
      ...
      children: [
                      ...
                      p.jsxs(
                        'tr',
                        {
                          children: [
                            ...
                            p.jsx('td', { className: 'price money', children: ce.format(c) }),
                            p.jsx('td', { children: m > 1 ? p.jsx('div', { className: 'qty', children: m }) : m }),
                            p.jsx('td', {
                              children: p.jsx('button', {
                                onClick: () => n({ type: 'REMOVE', payload: { id: u, price: c } }),
                                children: p.jsx(Bd, {}),
                              }),
                            }),
                            p.jsx('td', {
                              ...
                              children: p.jsx('div', { children: ce.format(h) }),
                            }),
                          ],
                        },
                        u
        ...
        p.jsxs('div', {
          ...
          children: [
            p.jsx('button', { onClick: () => n({ type: 'RESET', payload: {} }), children: p.jsx(Hd, {}) }),
            p.jsx('button', { onClick: () => l(!0), children: p.jsx(Wd, {}) }),
            p.jsx('button', { onClick: () => i(!0), children: p.jsx(Qd, {}) }),
          ],
        }),
        p.jsx(Ku, { visible: r, setVisible: l, children: p.jsx($d, {}) }),
        p.jsx(Ku, { visible: o, setVisible: i, children: p.jsx(Vd, {}) }),
      ],
    });
  },
  Yd = (e, { type: t, payload: n }) => {
    if (t === 'ADD') {
  ...
  Xd = ({ categoryItems: e }) => {
    const [t, n] = O.useReducer(Yd, { items: [], total: 0 });
    return p.jsx(er.Provider, {
      value: { state: t, dispatch: n },
      children: p.jsxs('div', { className: 'cashierGrid', children: [p.jsx(Fd, { categoryItems: e }), p.jsx(Kd, {})] }),
    });
  };
const Gd = (e) => {
    const t = e[0];
    return e
      ...
      .reduce((l, o) => {
        ...
        if (m) m.items.push(v);
          ...
          const h = { category: i, palette1: u, palette2: s, palette3: c, items: [v] };
          l.push(h);
        }
        return l;
      }, []);
  ...
  Jd = 'https://sheets.googleapis.com/$discovery/rest?version=v4',
  qd = 'https://www.googleapis.com/auth/spreadsheets',
  bd = ({ setCategoryItems: e, setTokenClient: t, setSheetName: n }) => {
    ...
    return (
      O.useEffect(() => {
        async function c() {
          await gapi.client.init({ apiKey: 'AIzaSyA4h2Wnm3i8dMEukuc3KX83MX-UqmqUdl4', discoveryDocs: [Jd] }), l(!0);
        }
      ...
      p.jsxs('form', {
        id: 'loginCard',
        onSubmit: (c) => {
          c.preventDefault(), o && r && s();
        },
        children: [
          'enter sheet name ↓',
          p.jsx('input', { type: 'text', placeholder: 'maomao', value: u, autoFocus: !0, onChange: (c) => n(c.target.value) }),
          p.jsx('button', { children: 'weee!' }),
        ],
      })
    );
  },
  Di = O.createContext('maomao'),
  ic = O.createContext({});
function ep() {
  const [e, t] = O.useState('maomao'),
    [n, r] = O.useState(),
    [l, o] = O.useState([]);
  return p.jsx(p.Fragment, {
    children: p.jsx(Di.Provider, {
      value: e,
      children: p.jsxs(ic.Provider, {
        value: n,
        children: [!n && p.jsx(bd, { setCategoryItems: o, setSheetName: t, setTokenClient: r }), p.jsx(Xd, { categoryItems: l })],
      }),
    }),
  });
}
Yl.createRoot(document.getElementById('root')).render(p.jsx(Cc.StrictMode, { children: p.jsx(ep, {}) }));
